...
public class BlogCompanyNewsPage extends BasePage {

    public BlogCompanyNewsPage(){
    ...
    @FindBy(xpath = "//button[normalize-space(text())='Company News']")
    private WebElement companyNewsButton;

    public void clickCompanyNewsButton(){
        waitAndClick(companyNewsButton);
    }
